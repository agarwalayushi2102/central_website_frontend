    ...
    <div className="fixed backdrop-brightness-50 flex justify-center items-center w-full h-full">
      <div className="bg-[#F3F3F3] w-[60%] h-[97%]  flex flex-row">
        <div className="w-[25%] h-full bg-[#E5E5E5] flex flex-col items-center">
          <h1 className="text-2xl font-bold underline text-center mt-2">Image Cards <img src="/edit.svg" className="inline h-6 w-6"/>
          </h1>
          <button className="w-[92%] h-[3rem] text-2xl bg-white rounded-xl font-semibold active:text-white active:bg-[#5267D0] justify-center mt-[14rem] mb-2">1. Image</button>
          <button className="w-[92%] h-[3rem] text-2xl bg-white rounded-xl font-semibold active:text-white active:bg-[#5267D0] justify-center my-2">2. Image</button>
          <button className="w-[92%] h-[3rem] text-2xl bg-white rounded-xl font-semibold active:text-white active:bg-[#5267D0] justify-center my-2">3. Image</button>
        ...
        <div className="flex flex-col w-[75%] items-center ">
          <div className="grid grid-cols-7 w-[100%]">
            <span className="col-span-5 text-2xl font-semibold pt-1 text-[#585E7C] text-right">
              Template 4 <img src="/downcap.svg" className="inline" />
            </span>
            <button
          ...
          <form className="flex flex-col w-full py-2">
            ...
            <textarea id="Description" placeholder="PROVIDE A DESCRIPTION" className="w-full h-36 bg-white text-lg font-semibold my-1 rounded-lg px-4 resize-none py-1"/>
            
           
            <button className="bg-[#CB4E4E] h-10 text-white w-full text-lg font-semibold my-2 rounded-lg mx-auto mt-[11rem]">Delete</button>
          </form>
          </div>
        </div>
      </div>
