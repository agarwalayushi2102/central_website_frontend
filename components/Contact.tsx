...
<div id='contact' className='mt-10 ml-[4rem]  h-12 px-6 py-1.5 bg-white font-[Inter] text-3xl font-bold  rounded-3xl shadow-md max-[360px]:text-2xl ' >
  Contact Us
        ...
        <div id='contact-box' className='mt-8 mb-16 flex flex-wrap justify-center items-start px-2 py-2 bg-white border-2 rounded-xl shadow-md text-xl md:w-[40rem] lg:w-[46.8rem] xl:w-[78.1rem] max-w-[95%]'>
          ...
          <div className='w-full md:w-[55%]'>
            {/* Map component */}
            <iframe className='border-2 rounded-xl w-full h-[20rem] max-[280px]:w-[15rem]' id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=IIT%20Indore%20Simrol+(IIT%20Indore)&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
          </div>
        </div>
      </div>
    </>
