    ...
    <div className="fixed backdrop-brightness-50 flex justify-center items-center w-full h-full">
      <div className="bg-[#F3F3F3] w-[60%] h-[97%]  flex flex-row">
        ...
        <div className="flex flex-col w-full items-center ">
          ...
          <h1 className="text-2xl font-bold underline text-center mt-2 col-span-2">Wide Image Card <img src="/edit.svg" className="inline h-6 w-6"/>
          </h1>
            <span className="col-span-3 text-2xl font-semibold pt-1 text-[#585E7C] text-right">
              Template 5 <img src="/downcap.svg" className="inline" />
            </span>
            <button
          ...
          <form className="flex flex-col w-full py-2 mt-2">
            ...
            <textarea id="Description" placeholder="PROVIDE A DESCRIPTION" className="w-full h-48 bg-white text-lg font-semibold my-1 rounded-lg px-4 resize-none py-1"/>
